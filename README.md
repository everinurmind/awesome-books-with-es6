...
Hello! Here you will see Awesome Books with ES6 project
...
``sh
  cd my-folder
  git clone https://github.com/everinurmind/awesome-books-with-es6``
...
Feel free to check the [issues page](https://github.com/everinurmind/awesome-books-with-es6/issues).
